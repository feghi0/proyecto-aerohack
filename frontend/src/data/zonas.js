// Zonas térmicas recortadas contra el perímetro real de Monte Castro.
// Fuente base del perímetro: OpenStreetMap relation 2221446.
export const zonasMontecastro = [
  {
    id: 'zona-1',
